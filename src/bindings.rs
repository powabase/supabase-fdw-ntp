...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:powabase:supabase-fdw-ntp@0.2.5:ntp-fdw:encoded world"
)]
#[doc(hidden)]
...
s@0.2.0\x05\x0b\x04\0'powabase:supabase-fdw-ntp/ntp-fdw@0.2.5\x04\0\x0b\x0d\x01\0\
